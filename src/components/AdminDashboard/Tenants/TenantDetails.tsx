...
//   const { data: tenant, isLoading: tenantLoading } = useGetTenantByIdQuery(id!);
//   const { data: roles } = useGetRolesByTenantQuery({
//     tenantId: id!,
//     page: 1,
//     limit: 50,
//   });
//   const { data: users } = useGetUsersByTenantQuery({
//     tenantId: id!,
//     page: 1,
//     limit: 50,
//   });
...
//       <button
//         onClick={() => navigate("/admin-dashboard/tenants")}
//         className="flex items-center gap-2 text-[#052350] mb-6 hover:underline"
//       >
//         <FaArrowLeft /> Back to Tenants
//       </button>
...
//                 <span>{role.name}</span>
//                 <span
//                   className={`px-2 py-1 rounded-full text-xs ${role.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
//                 >
//                   {role.isActive ? "Active" : "Inactive"}
//                 </span>
//               </div>
