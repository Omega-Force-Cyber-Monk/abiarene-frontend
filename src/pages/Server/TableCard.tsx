export const TableCard = ({ id, seats, status, subStatus }) => {
  const isOccupied = status === "OCCUPIED";

  return (
    <div className={`p-6 rounded-4xl transition-all border border-transparent 
      ...
      <div className="space-y-1 mb-6">
        ...
        <p className="text-gray-400 font-medium">{seats} Seat</p>
      </div>
